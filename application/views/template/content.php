			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<ul class="nav nav-tabs nav-tabs-inverse nav-justified nav-justified-mobile" data-sortable-id="index-2">
                                                <li class="active"><a href="#latest_institute" data-toggle="tab"><i class="fa fa-envelope m-r-5"></i> <span class="hidden-xs">Latest Institute</span></a></li>
						<li class=""><a href="#latest-questions" data-toggle="tab"><i class="fa fa-picture-o m-r-5"></i> <span class="hidden-xs">Latest Questions</span></a></li>
						<li class=""><a href="#latest_exams" data-toggle="tab"><i class="fa fa-shopping-cart m-r-5"></i> <span class="hidden-xs">Latest Exams</span></a></li>
						<li class=""><a href="#latest_users" data-toggle="tab"><i class="fa fa-envelope m-r-5"></i> <span class="hidden-xs">Latest Users</span></a></li>
					</ul>
					<div class="tab-content" data-sortable-id="index-3">
                                            <div class="tab-pane fade active in" id="latest_institute">
						...
						<div class="tab-pane fade active in" id="latest-questions">
							<div class="height-sm" data-scrollbar="true">
								<ul class="media-list media-list-with-divider">
									<li class="media media-lg">
										<a href="javascript:;" class="pull-left">
						...
						<div class="tab-pane fade" id="latest_exams">
							<div class="height-sm" data-scrollbar="true">
								<table class="table">
									<thead>
										<tr>
