						...
						<ul class="nav">
							...
							<li class="has-sub">
								...
								<ul class="sub-menu">
									...
									<li class="has-sub">
										<a href="javascript:;"><b class="caret pull-right"></b> Users Setup <i class="fa fa-paper-plane text-theme m-l-5"></i></a>
										<ul class="sub-menu">
											<li><a href="user_index.html">Users Group</a></li>
											<li><a href="user_index.html">Users Module</a></li>
											<li><a href="table_manage_tabletools.html">Users Role</a></li>
											<li><a href="table_manage_combine.html">Users <i class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
										</ul>
									</li>
									<li class="has-sub">
										<a href="javascript:;"><b class="caret pull-right"></b> Module Setup <i class="fa fa-paper-plane text-theme m-l-5"></i></a>
										<ul class="sub-menu">
									...
									<li class="has-sub">
										<a href="javascript:;"><b class="caret pull-right"></b>Institute Setup<i class="fa fa-paper-plane text-theme m-l-5"></i></a>
										<ul class="sub-menu">
									...
									<li class="has-sub">
										<a href="javascript:;"><b class="caret pull-right"></b> Individual Setup <i class="fa fa-paper-plane text-theme m-l-5"></i></a>
										<ul class="sub-menu">
									...
									<li class="has-sub">
										<a href="javascript:;"><b class="caret pull-right"></b> General Setup <i class="fa fa-paper-plane text-theme m-l-5"></i></a>
										<ul class="sub-menu">
							...
							<li class="has-sub">
								...
								<ul class="sub-menu">
									<li><a href="<?php echo base_url();?>welcome/formElement">Form Elements</a></li>
